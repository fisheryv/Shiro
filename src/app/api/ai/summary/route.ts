...
export const GET = async (req: NextRequest) => {
  ...
  await sql`create table if not exists summary (id int NOT NULL PRIMARY KEY, api_endpoint varchar(30), summary text, lang varchar(10), modified varchar(40), cid varchar(40))`
